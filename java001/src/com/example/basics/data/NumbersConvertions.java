...
public class NumbersConvertions {
    public static void main(String[] args) {
        ...
        //rzutowanie / casting
        double d2 = 5.5;
        int num = 10*(int)d2; //przy rzutowaniu/konwersji float/double na typ całkowity
                              //część ułamkowa jest tracona
        System.out.println(num); //50

        byte small = (byte) 200; //rzutowanie z short na byte
